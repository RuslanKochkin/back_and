...
//* Дан список имен. Имена в списке повторяются.
// Необходимо получить map в котором ключ будет имя, а значение – сколько раз это имя встретилось в исходном списке.
