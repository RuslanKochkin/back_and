...
import static de.ait.WeatherTools.getWindDescription;

public class Main {
    public static void main(String[] args) {
        System.out.println("Hello world!");

        System.out.println(getWindDescription( 19 , false));
    ...
    public static boolean isValidLogin(String login) {
            return (login.length() >= 8 && login.length() <= 20 && login.contains("@"));
    }
